function loadMachinesToUpdate(){
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            */
            if (tempt == "0") {
                ons.notification.alert('No hay maquinas para mostrar!', {title: "Tuvimos un problema!"});
            } else if (tempt != "0") {
                document.getElementById("machinesToUpdate").innerHTML = "" + tempt;
            }else{
    ...
    xhttp.open("GET", "https://luisramirez3006.000webhostapp.com/FlexogP/update.php", true);
